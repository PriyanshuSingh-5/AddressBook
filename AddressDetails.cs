...
{
    class AddressDetails : EachPerson
    {
        private Dictionary<string, ContactDetails> addressBook = new Dictionary<string, ContactDetails>();
        ...
        {
            foreach (KeyValuePair<string, ContactDetails> item in addressBook)
            {
        ...
        {
            foreach (KeyValuePair<string, ContactDetails> item in addressBook) //use loop foreach
            {
